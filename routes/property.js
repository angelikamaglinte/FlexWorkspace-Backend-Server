...
router.post('/', [
  authMiddleware,
  upload.array('images', 12), // Handling multiple file uploads with a limit of 12
  // [
  ...
  try {
    ...
    const {
      address, neighborhood, city, province, workspaceType, squareFeet,
      leaseTerm, price, parkingGarage, publicTransport
    } = req.body;
